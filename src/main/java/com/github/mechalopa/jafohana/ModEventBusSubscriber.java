...
public class ModEventBusSubscriber
{
	...
	public static void registerCompostables()
	{
		...
		ComposterBlock.COMPOSTABLES.put(ModItems.OAKLEAF_HYDRANGEA.get(), 0.65F);
		ComposterBlock.COMPOSTABLES.put(ModItems.FIREWEED.get(), 0.65F);
		ComposterBlock.COMPOSTABLES.put(ModItems.ALPINE_RAGWORT.get(), 0.65F);
		ComposterBlock.COMPOSTABLES.put(ModItems.TATARIAN_ASTER.get(), 0.65F);
